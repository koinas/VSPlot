...
$(EXECUTABLE_NAME) : $(SRC_FILES)
  csc  /noconfig /unsafe+ /nowarn:1701,1702 /errorreport:prompt /warn:4 /define:DEBUG;TRACE \
  ...
  /target:library \
  /debug+ /debug:full /keyfile:vsplot\Key.snk /optimize- /out:vsplot\obj\Debug\vsplot.dll \
  $(SRC_FILES)
